...
/*   Updated: 2025/11/09 16:11:48 by sdadak           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../so_long.h"

static void    fill(char **map, int y, int x, t_game game)
{
...
static void  ft_e_c_check(char **map, t_game *game)
{
    int i;
    int j;
...
void    ft_is_accessible(t_game *game)
{
    ...
    map_copy[i] = NULL;
    fill(map_copy, game->player_y, game->player_x, *game);
    ft_e_c_check(map_copy, game);
